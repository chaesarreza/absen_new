...
$query = $koneksi->query("SELECT nama_madrasah FROM pengaturan LIMIT 1");
$data = $query->fetch_assoc();
// Jika data kosong, beri nama default agar fungsi checkLicense tidak error
$madrasah_db = ($data) ? $data['nama_madrasah'] : "Madrasah Default";
